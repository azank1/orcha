...
> Experimental spikes ship behind `ORCHA_DAN_EXPERIMENTAL=true` or `network.experimental: true` in emerge.yaml. The gate controls when gossip becomes the default, not when engineering starts.
