...
- **Status:** Draft (hackathon window; India DPI / Know-Your-Agent build)
- **Type:** Additive, backward-compatible — schema minor bump `1.1` → `1.2`
- **Workstream:** FR-1 of `docs/hackathon-cambridge/india-feat/kya-srs-aac-dpi.md`
  (Agentic Authorization Charter)
...
counterparties, jurisdictions). The DPI/KY-A product
(`docs/hackathon-cambridge/india-feat/kya-srs-aac-dpi.md`, FR-1) needs that scope to
evolve into an **Agentic Authorization Charter (AAC)**: a versioned,
