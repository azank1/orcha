...
**Phase 0 design** is open for RFC issues — it hasn't been built yet. If you have opinions on the gossip protocol, peer discovery, signed envelope format, or anti-spam design, open an RFC.

**Phase 1–3** are further out. Specs here are working documents, not frozen designs. Design participation is the point.
